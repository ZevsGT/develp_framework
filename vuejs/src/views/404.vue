  ...
  <main class="body_404">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 align-self-center">
          <h1>404</h1>
          <h2>УХ ОЙ! Вы заблудились.</h2>
          <p>Страница, которую вы ищете, не существует.
            Как вы сюда попали - загадка. Но вы можете нажать кнопку ниже,
            чтобы вернуться на главную страницу.
          </p>
          <router-link to="/" class="btn green">На главную</router-link>
        </div>
      </div>
    </div>
  </main>
