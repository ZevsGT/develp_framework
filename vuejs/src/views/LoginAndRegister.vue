...
<style>
  ...
  .container_l.sign-up-mode:before {
  ...
  .container_l.sign-up-mode .signin-signup {
    left: 25%;
  }

  .container_l.sign-up-mode form.sign-up-form {
    opacity: 1;
    z-index: 2;
  }

  .container_l.sign-up-mode form.sign-in-form {
    opacity: 0;
    z-index: 1;
  }
  ...
  .container_l.sign-up-mode .left-panel {
    pointer-events: none;
  }

  .container_l.sign-up-mode .right-panel {
    pointer-events: all;
  }
